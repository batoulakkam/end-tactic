...
$age="";
$gender="";
$ID="";$job="";$edu="";$VIP="";$nationality=""; $optional="";
  ...
  <div class="mainContent">
    <div class="container">
      <div class="panel panel-primary">
		...
		<form action="" class="formDiv" id="formDiv" method="post">
			<?php  if ($masg !="") echo $masg."<br>"; ?>
			<div class="col-md-12">
            <div class="form-group form-group-lg">
             <label  class="control-label"> الاسم</label><label style="color:red">*&nbsp; </label>
             <input type="text" class="form-control" id="nameAttendee" name="nameAttendee" >
              </div>
            </div>
      		<div class="col-md-12">
            <div class="form-group form-group-lg">
             <label  class="control-label"> البريد الالكتروني</label><label style="color:red">*&nbsp; </label>
             <input type="email" id="emailAttendee" name="emailAttendee" class="form-control" required>
              </div>
            </div>
			<?php
 for ($x = 2; $x < $length; $x++){
				if($field [$x] == 'الهاتف' && $requierd [$x] == 1 ){
					echo '<div class="col-md-12">
					    ...
					    <input type="text" class="form-control" id="phoneAttendee"  name="phoneAttendee">
						</div>
						</div>';
				}
		else {
            ...
            <div class="form-group form-group-lg">
             ...
             <input type="text" class="form-control" id="txtPhone" requiered name="phoneAttendee">
              </div>
            </div>';
			}
			}//end else 
	...
	echo '<div class="col-md-12">
     <div class="form-group form-group-lg">
      <label  class="control-label"> العمر</label><label style="color:red">*&nbsp; </label>
       <input type="date" required class="form-control" id="ageAttendee"  name="ageAttendee" 
	   value="1995-12-29"  >
          </div>
            </div>';
		break;}
      ...
      <div class="col-md-12">
          <div class="form-group form-group-lg">
             <label class="control-label"> مستوى التعليم</label><label style="color:red">*&nbsp; </label>
                <select id="eduAttendee" name="eduAttendee" class="form-control" oninvalid="this.setCustomValidity("هذا الحقل مطلوب يرجى اختيار مستوى التعليم")>
      ...
      <div class="col-md-12">
		...
		if($field [$x] == 'المهنة'  && $requierd [$x] == 1  ){
            ...
            <div class="form-group form-group-lg">
             ...
             <input type="text" class="form-control" id="jobAttendee"  name="jobAttendee"
                  >
              </div>
            </div>';
		}
           ...
           <select id="education" name="natiAttendee" class="form-control">
	...
	<option value="HK">هونج كونج الصينية</option>
		...
		if($field [$x] == 'الهوية'  && $requierd [$x] == 1 ){
		echo '
				<div class="col-md-12">
				<div class="form-group form-group-lg">
				 <label for="eventName" class="control-label">رقم الهوية</label> <label style="color:red">*&nbsp; </label>
				 <input type="text" class="form-control" id="IDAttendee"  name="IDAttendee"
					 >
				  </div>
				</div>';
			}
