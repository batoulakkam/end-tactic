<?php
	...
	if (isset($_GET['eventName']) && $_GET['eventName'] != '') {
	 ...
	 if (isset($_SESSION['organizerID'])) {
	  ...
	  $current = date('Y-m-d');
	  $query = mysqli_query($con, "SELECT * FROM event WHERE organizer_ID = '$orgID' AND sartDate_Event = ' $current' AND endDate_Event >= ' $current' ") or die(mysqli_error($con));
	 }
	}
?>
          ...
          <tr>
            ...
            <th> التسجيل الفوري </th>
              ...
              <?php
                ...
                echo "<td> <a href='" . $row['eventLink'] ." '> <span class=' 	fa fa-edit	
